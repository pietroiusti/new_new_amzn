...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  text-align: center;\n  width: 90%;\n  margin: auto;\n  max-width: 1000px;\n  font-family: 'Roboto', sans-serif;\n}\n\n#basketDiv2 {\n  background-color: #a89932;\n  width: 40%;\n  margin: auto;\n  border-radius: 10px;\n}\n\n#basketDiv {\n  background-color: #2ecc71;\n  width: 40%;\n  margin: auto;\n  border-radius: 10px;\n}\n\n#itemList {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  grid-column-gap: 5px;\n  margin: auto;\n  max-width: 1000px;\n}\n\n.item {\n  background-color: #d9fceb;\n  margin: 10px;\n  padding: 10px;\n  border-radius: 25px;\n}\n", "",{"version":3,"sources":["webpack://./src/css/myamazon.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,UAAU;EACV,YAAY;EACZ,iBAAiB;EACjB,iCAAiC;AACnC;;AAEA;EACE,yBAAyB;EACzB,UAAU;EACV,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,yBAAyB;EACzB,UAAU;EACV,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,2DAA2D;EAC3D,oBAAoB;EACpB,YAAY;EACZ,iBAAiB;AACnB;;AAEA;EACE,yBAAyB;EACzB,YAAY;EACZ,aAAa;EACb,mBAAmB;AACrB","sourcesContent":["body {\n  text-align: center;\n  width: 90%;\n  margin: auto;\n  max-width: 1000px;\n  font-family: 'Roboto', sans-serif;\n}\n\n#basketDiv2 {\n  background-color: #a89932;\n  width: 40%;\n  margin: auto;\n  border-radius: 10px;\n}\n\n#basketDiv {\n  background-color: #2ecc71;\n  width: 40%;\n  margin: auto;\n  border-radius: 10px;\n}\n\n#itemList {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  grid-column-gap: 5px;\n  margin: auto;\n  max-width: 1000px;\n}\n\n.item {\n  background-color: #d9fceb;\n  margin: 10px;\n  padding: 10px;\n  border-radius: 25px;\n}\n"],"sourceRoot":""}]);
// Exports
